                        ...
                        <div class="panel-body bio-graph-info">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label class="checkbox-inline">
                                        <input type="radio" id="inlineCheckbox2" name="gender" value="female"> Female
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="userName" id="userName" value="<?php echo set_value('userName'); ?>" placeholder=" ">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <select class ="form-control" name="type" id="type">
                                            ...
                                            foreach ($this->flexi_auth->get_groups()->result_array() as $a_type) {
                                                echo "<option value='" . $a_type['ugrp_id'] . "'>" . $a_type['ugrp_name'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <input type="submit" name="register_user" value="Save" class="btn btn-info">
